package com.vusieam.invascan.ui.main
...
import com.vusieam.invascan.databinding.ActivityMainBinding
...
import com.vusieam.invascan.services.RetrofitAuthenticatedService
                ...
                override fun onResponse(
                    ...
                    if(!response.isSuccessful){
                        runOnUiThread {
                            if (loader.isShowing)
                                loader.dismiss()
                            val dialog = SweetAlertDialog(this@MainActivity, SweetAlertDialog.ERROR_TYPE)
                            dialog.window?.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT))
                            dialog.titleText = GenericHelpers.titleID()
                    ...
                    if(detectionModel == null){
                        runOnUiThread {
                            if (loader.isShowing)
                                loader.dismiss()
                            val dialog = SweetAlertDialog(this@MainActivity, SweetAlertDialog.SUCCESS_TYPE)
                            dialog.window?.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT))
                            dialog.titleText = GenericHelpers.titleID()
                            dialog.contentText = responseBody.statusMessage
                            dialog.show()
