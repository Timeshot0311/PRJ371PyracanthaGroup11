...
const ROLE_IDS: Record<"ADMIN" | "FARMER" | "SME", string> = {
  ...
  FARMER: "0183C0ED-AA36-48D8-829B-893B9D2ABE86",
...
export function SignUpForm() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res?.status === false)
        throw new Error(res?.statusMessage || "Sign up failed");
      ...
      queryClient.setQueryData(authQueryOptions().queryKey, tk.access_token);
          ...
          <label className="hover:bg-accent/50 flex items-start gap-3 rounded-lg border p-3 has-[[aria-checked=true]]:border-primary/50 has-[[aria-checked=true]]:bg-primary/25">
            ...
            <div className="grid gap-1.5 font-normal">
              ...
              <p className="text-muted-foreground text-sm">
                I agree to allow this site to store my uploaded images for
                analysis and database storage purposes.
              </p>
            </div>
          </label>
