...
@router.get("/all_province", summary="All Province Statistics", response_model=GenericApiResponse[list[ProvinceStatistics]])
...
@router.get("/province/{province_name}", response_model=GenericApiResponse[ProvinceStatistics])
...
@router.get("/locationDetails", response_model=GenericApiResponse[list[LocationDetails]])
...
@router.get("/locationDetails/{province}", response_model=GenericApiResponse[list[LocationDetails]])
...
@router.get("/locationDetails/{year_filter}", response_model=GenericApiResponse[list[LocationDetails]])
...
@router.get("/locationDetails/{year}/{month}", response_model=GenericApiResponse[list[LocationDetails]])
async def get_year_location_details(year_filter:int, month:int, user_id: str = Depends(get_current_user), db: AsyncSession = Depends(get_db)):
    service = ReportsService(ReportsRepository(AsyncSessionLocal))
